...
const messages: Record<Language, Messages> = {
  ko: {
    ...
    stage2Anchor: '✅ 필수과목',
    stage2Signal: '✨ 관심·성향 선택과목',
    stage2AnchorHelper: '졸업 필수와 핵심 과목 중심',
    stage2SignalHelper: '흥미·성향에 맞는 선택 과목',
  ...
  en: {
    ...
    stage2Anchor: '✅ Required Courses',
    stage2Signal: '✨ Interest-fit Electives',
    stage2AnchorHelper: 'Focus on core, required subjects',
    stage2SignalHelper: 'Electives that match interests and temperament',
